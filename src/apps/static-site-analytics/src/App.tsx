...
const StaticSiteAnalyticsApp = () => {
  ...
  }, [app, staticSiteId, selectedTimeframe])
  ...
  if (!staticSiteId) {
    return <div className="loading">Waiting for static site data...</div>
  }
...
export default StaticSiteAnalyticsApp
